...
class Signup extends CI_Controller
{
     ...
     public function registeration()
        {
            ...
            if(count($chkmail)==0)
            {
                ...
                if($userid)
                {
                    ...
                    $this->session->set_flashdata('success', 'Thank you for registration. Please verify email and login.');
                    redirect(base_url());
                }
                else
                {
    ...
    public function verifymail($name,$toemail,$userid)
    {
        ...
        $subject='Registeration and Verification mail';
...
<div style="margin-bottom:10px;">Thank you for registering at <b>'.project_name().'</b> ! You can store your crypto currency safe and secure. Feel free to invite your friends and family members to <b>'.project_name().'</b> community.<br><br> 
...
<div style="margin-bottom:10px;"><b>'.base_url().'</b></div>
        ...
        $this->email->from(sending_mail(), $subject);
