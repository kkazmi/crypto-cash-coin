        ...
        <?php } ?>
                    <form action="<?php echo base_url()?>sendamount/transferamount" method="POST" id="sendform" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="amount" name="amount" class="form-control validate[required,custom[integer],min[0]] col-md-7 col-xs-12" value="" onkeypress="return isNumberKey(event)">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Pin <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="pin" class="form-control validate[required,minSize[6],maxSize[6]] col-md-7 col-xs-12" type="text" name="pin" value="">
                        </div>
                      </div>
