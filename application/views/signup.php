  ...
  <body class="login" style="background-image: url('<?php echo login_bg();?>');">
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form" id="logingrid">
          ...
          <section class="login_content">
            <form action="<?php echo base_url()?>/signup/registeration" method="POST"  id="signupform">
             <h1><img src="<?php echo logo_url() ?>"></h1>
              ...
              <div>
                <input type="password" id="pin" name="pin" class="form-control validate[required,minSize[6],maxSize[6]]" placeholder="6 Digit Pin"   maxlength="6"/>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  ...
                  <p>©2017 All Rights Reserved. <?php echo project_name();?></p>
                </div>
              </div>
            </form>
          </section>
